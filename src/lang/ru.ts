const ru = {
  ...
  fullLoadingTitle: "Формируем подробное описание…",
  retry: "Повторить",
  cancel: "Назад",
  ...
  fullOfflineTitle: "Не удалось загрузить полный результат.",
  offlineHint: "Похоже, нет подключения к сети.",
